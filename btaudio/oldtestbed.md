...
I recommend spacing the components out as described below to support moving wires around as we test various things.  You can see an example of how mine is setup [here](images/testbed.jpg).
